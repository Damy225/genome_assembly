...
out=./comparison/prokka/S5/

#Run Prokka on the hyrbid assembly
prokka --outdir "$out"/hybrid --force --prefix s5hybrid --genus Haloferax --species volcanii $HyA

#Run Prokka on the long assembly
prokka --outdir "$out"/long --force --prefix s5long --genus Haloferax --species volcanii $LoA

#Run Prokka on the short assembly
prokka --outdir "$out"/short --force --prefix s5short --genus Haloferax --species volcanii $ShA
