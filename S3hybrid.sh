...
sh1=./illumina/*S3*R1.fastq.gz
sh2=./illumina/*S3*R2.fastq.gz
long=./nanopore/barcode03pass.fastq.gz


# Run hybrid assembly for sample 1
unicycler --kmers 21,33,55 -1 $sh1 -2 $sh2 -l $long -o /shared/Project1_Resources/Group2/assemblies/hybrid/S3
